...
// This hook detects if the clicks are outside or inside of the specified component and calls the provided handler function if the click is outside
export default function useOnClickOutside(ref, handler) {
  useEffect(() => {
    //listener function to be called on click/touch events
    ...
    //event listeners for mousedown and touchstart events on the document
